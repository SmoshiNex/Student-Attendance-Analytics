...
export const APP_BASE = import.meta.env.DEV ? "" : "/Student%20Attedance%20Analytics/public";
...
export function getPublicAppOrigin() {
    ...
    const resolvedHost =
        isLoopbackHost(hostname) && lanHost ? lanHost : hostname;
    const resolvedPort =
        isLoopbackHost(hostname) && lanPort ? lanPort : currentPort;

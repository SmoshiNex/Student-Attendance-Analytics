...
// ── Reply preview bar ─────────────────────────────────────
function ReplyPreview({ msg, onCancel, isOwn }) {
  if (!msg) return null
  const text =
    msg.message ||
  ...
  return (
    ...
    >
      <p className="text-[10px] font-semibold leading-none">
        {msg.reply_sender_type === "teacher" ? "You" : msg.reply_sender_type}
      </p>
...
export default function TeacherMessages() {
  ...
  const loadInbox = useCallback(() => {
    ...
    axios
      .get(
        messagesApiUrl("inbox", { user_type: "teacher", user_id: teacher.id }),
  ...
  const loadClassStudents = useCallback(
    (classId) => {
      ...
      setClassStudents([])
      axios
        .get(teacherClassApiUrl({ action: "students", id: classId }), {
          withCredentials: true,
        })
  ...
  const sendMessage = async () => {
    if ((!draft.trim() && !pendingFile) || !activeThread || !teacher || sending)
      return
    setSending(true)
  ...
  const startChatWithStudent = (student) => {
    const thread = {
      ...
      partner_name: `${student.first_name} ${student.last_name}`.trim(),
      partner_student_id: student.student_id,
    }
    setActiveThread(thread)
    setShowNewChat(false)
    setSelectedClass(null)
            ...
            {showNewChat ? (
                  ...
                  {!selectedClass ? (
                    <div>
                      <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3 flex items-center gap-1.5">
                        <BookOpen className="w-3.5 h-3.5" /> Step 1 — Select a
                        Class
                      </p>
                      {loadingClasses ? (
                        ...
                        <div className="flex flex-col gap-2">
                          {classes.map((cls) => (
                            <button
                              ...
                              className="w-full text-left rounded-xl border border-gray-200 px-4 py-3 hover:border-gray-900 hover:bg-gray-50 transition-all"
                            >
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider flex items-center gap-1.5">
                          <Users className="w-3.5 h-3.5" /> Step 2 — Select a
                          Student
                        </p>
                      </div>
                          ...
                          {filteredStudents.map((s) => {
                            ...
                            return (
                              <button
                                ...
                                className="w-full text-left rounded-xl px-3 py-2.5 hover:bg-gray-100 transition-colors flex items-center gap-3"
                              >
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center px-6">
                ...
                <p className="text-sm text-gray-400">
                  Choose a student from the left, or tap{" "}
              ...
              <>
                ...
                <div className="px-4 py-3 border-b border-gray-100 bg-gray-50 flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-gray-400">
                      Student
                      {activeThread.partner_student_id
                        ? ` • ${activeThread.partner_student_id}`
                        : ""}
                    </p>
                  </div>
                  ...
                  {loadingMsgs ? (
                    ...
                    messages.map((msg) => {
                      const isOwn =
                        ...
                        Number(msg.sender_id) === Number(teacher?.id)
                      return (
                        <div
                          key={msg.id}
                ...
                {replyTo && (
                  <ReplyPreview
                    ...
                    isOwn={replyTo.sender_type === "teacher"}
                  />
                )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <p className="mt-2 text-sm text-gray-600 leading-relaxed">
              This only removes the chat from your side. The student can still
              see the messages.
            </p>

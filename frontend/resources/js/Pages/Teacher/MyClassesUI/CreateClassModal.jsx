...
export default function CreateClassModal({ isOpen, onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            onClose();
            setErrorModal({ open: true, message: error?.response?.data?.message || "Failed to create class." });
        } finally {
            setProcessing(false);
        }
    };
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                updateField("class_code", e.target.value)
                            }
                        />
                        {errors.class_code && (
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                updateField("subject_name", e.target.value)
                            }
                        />
                        {errors.subject_name && (
                            <p className="text-sm text-red-500">

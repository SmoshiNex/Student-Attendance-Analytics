            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
              ...
              {notifications.length > 0 && (
                <button
                  ...
                  className="text-sm text-blue-600 hover:text-blue-800 font-medium disabled:opacity-50 w-full sm:w-auto text-left sm:text-right"
                >
                  Mark all as read
                </button>
              )}
                  ...
                  >
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                          <div className="min-w-0">
                            ...
                            {notification.metadata && (
                              <div className="mt-2 text-xs text-gray-500 flex flex-wrap gap-2 sm:gap-4">
                        ...
                        <div className="flex flex-wrap items-center gap-2 sm:gap-4 mt-3 text-xs text-gray-400">
